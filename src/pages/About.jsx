        ...
        <div className="about-page">
            ...
            <div className="about-grid">
                <div className="biography">
                    <h2 className="text-2xl font-bold mb-4 uppercase">Biography - Full Stack Developer</h2>
                    <p>Hi, I'm Kavya Agrawal, an expert Website Developer and SaaS Developer with a passion for creating beautiful, functional, and user-centered digital experiences. With 5 years of experience in the field, I am always looking for new and innovative ways to bring my clients' visions to life.</p>
                    <p>I believe that design is about more than just making things look pretty – it's about solving problems and creating intuitive, enjoyable experiences for users as an App Developer.</p>
                    <p>Whether I'm working on a website, mobile app, or other SaaS architecture, I bring my commitment to design excellence and user-centered thinking to every project I build. I look forward to the opportunity to bring my skills and passion to your next project.</p>
                </div>
